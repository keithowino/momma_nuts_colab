...
// 			<Navigate
// 				to={
// 					user.role === "admin" ? "/admin-products" : "/user-products"
// 				}
// 			/>
// 		);
// 	}
...
// 					<div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-momma-brown to-momma-orange rounded-full mb-4">
...
// 					<p>Demo: use your registered email/phone and password</p>
// 				</div>
// 			</div>
// 		</div>
// 	);
